    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* Eyebrow */}
          <span className="inline-block text-[11px] sm:text-xs font-cinzel font-bold tracking-[0.4em] uppercase text-[#D4AF37] mb-3">
          ...
          >
            ...
            marries Parisian cosmetic excellence with cold-pressed
