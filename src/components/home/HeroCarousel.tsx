...
export const HeroCarousel: React.FC = () => {
  ...
  return (
    <section id="hero-banner" className="relative w-full bg-[#007288] overflow-hidden select-none border-b border-[#D4AF37]/30" onMouseEnter={() => setIsPlaying(false)} onMouseLeave={() => setIsPlaying(true)}>
      {/* =========================================================
          HERO BANNER
      ========================================================= */}
      <div className="relative w-full aspect-[3/4] sm:aspect-[16/9] md:aspect-[3.6/1] overflow-hidden bg-[#006073]">
        {/* =====================================================
            SUBTLE GOLD AURA
        ===================================================== */}
        ...
        {/* =========================================================
            MOBILE ARROWS
        ========================================================= */}
        <div className="absolute inset-y-0 left-2 right-2 z-30 flex items-center justify-between pointer-events-none md:hidden">
          {/* Previous */}
          ...
          {/* Next */}
          <button type="button" onClick={(e) => { e.stopPropagation(); nextSlide(); }} className="pointer-events-auto w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-full bg-[#006073]/75 hover:bg-[#007288] text-[#D4AF37] hover:text-[#FFF3C4] border border-[#D4AF37]/50 backdrop-blur-md shadow-lg transition-all duration-300 active:scale-90" aria-label="Next campaign banner">
        ...
        {/* =========================================================
            DESKTOP ARROWS
        ========================================================= */}
        <div className="absolute inset-y-0 left-4 right-4 lg:left-6 lg:right-6 z-30 hidden md:flex items-center justify-between pointer-events-none">
          {/* Previous */}
          <button type="button" onClick={(e) => { e.stopPropagation(); prevSlide(); }} className="pointer-events-auto w-10 h-10 lg:w-12 lg:h-12 flex items-center justify-center bg-[#006073]/80 hover:bg-[#007288] text-[#D4AF37] hover:text-[#FFF3C4] border border-[#D4AF37]/50 backdrop-blur-md transition-all duration-300 shadow-xl group cursor-pointer" aria-label="Previous campaign banner">
            <ChevronLeft className="w-5 h-5 lg:w-6 lg:h-6 transition-transform group-hover:-translate-x-0.5" />
          </button>

          {/* Next */}
          <button type="button" onClick={(e) => { e.stopPropagation(); nextSlide(); }} className="pointer-events-auto w-10 h-10 lg:w-12 lg:h-12 flex items-center justify-center bg-[#006073]/80 hover:bg-[#007288] text-[#D4AF37] hover:text-[#FFF3C4] border border-[#D4AF37]/50 backdrop-blur-md transition-all duration-300 shadow-xl group cursor-pointer" aria-label="Next campaign banner">
      ...
      ========================================================= */}
      <div className="md:hidden w-full bg-[#006073] border-t border-[#D4AF37]/20 px-4 py-2.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5">
            {slides.map((slide, idx) => {
              ...
              return (
                <button key={slide.id} type="button" onClick={() => setCurrentIndex(idx)} aria-label={`Go to slide ${idx + 1}`} className={`h-1.5 rounded-full transition-all duration-300 ${isActive ? "w-7 bg-[#D4AF37]" : "w-1.5 bg-[#8EAAB0]/50"}`} />
              );
            })}
          </div>
          ...
          {/* Play / Pause */}
          <button type="button" onClick={() => setIsPlaying(!isPlaying)} className="flex items-center justify-center w-7 h-7 border border-[#D4AF37]/30 bg-[#006073] text-[#D4AF37] transition-colors active:bg-[#007288]" aria-label={isPlaying ? "Pause slideshow" : "Play slideshow"}>
