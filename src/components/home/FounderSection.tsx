            ...
            <div className="relative z-10 overflow-hidden bg-[#006073] border-2 border-[#D4AF37]/60 shadow-[0_20px_50px_rgba(0,96,115,0.85)]">
              ...
              <div className="absolute top-0 inset-x-0 p-5 bg-gradient-to-b from-[#006073]/95 via-[#006073]/80 to-transparent flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className=" text-xs font-bold text-[#F3E5AB] tracking-widest uppercase">
                    JAC GHRÉ
                  </span>
                </div>
                <span className="text-[10px]  tracking-widest text-[#D4AF37] uppercase font-bold border border-[#D4AF37]/40 px-2 py-0.5 bg-[#006073]/60">
                  BEAUTY EXPERT
                </span>
              </div>

              {/* Global Atelier Identity Overlay */}
              <div className="absolute bottom-4 inset-x-4 p-3.5 bg-[#006073]/95 border border-[#D4AF37]/50 backdrop-blur-md flex items-center justify-between text-xs  text-[#F3E5AB]">
          ...
          >
            ...
            <div className="p-5 bg-gradient-to-r from-[#007288] to-[#006073] border-l-4 border-[#D4AF37] space-y-1.5 shadow-xl">
              ...
              <div className="flex items-center justify-between pt-1 border-t border-[#D4AF37]/20">
                <span className="text-xs  text-[#D4AF37] tracking-widest uppercase font-bold">
                  — Jac Ghré
                </span>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              ...
              {/* <button
                ...
                className="px-5 py-3.5 bg-[#006073] border border-[#D4AF37]/60 text-[#F3E5AB]  text-xs font-bold tracking-[0.15em] uppercase hover:bg-[#007288] transition-all cursor-pointer"
              >
      ...
      {showBookingModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="relative max-w-md w-full p-8 bg-[#006073] border-2 border-[#D4AF37] shadow-2xl">
            <h3 className=" text-xl text-[#F7F4EB] uppercase tracking-wider mb-2 text-center">
            ...
            {booked ? (
              <div className="p-4 bg-[#007288] border border-[#D4AF37] text-center text-xs  text-[#F3E5AB]">
              ...
              >
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    type="submit"
                    className="flex-1 py-3 bg-[#D4AF37] text-[#062B35]  text-xs font-bold uppercase cursor-pointer"
                  >
                    Submit Request
                  </button>
                  <button
