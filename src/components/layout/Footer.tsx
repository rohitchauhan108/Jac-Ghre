...
const TikTokIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      d="M14.5 3c.6 2 2.1 3.3 4.3 3.5v2.6c-1.3 0-2.5-.3-3.6-.9v6.2c0 3.2-2.6 5.8-5.8 5.8s-5.8-2.6-5.8-5.8 2.6-5.8 5.8-5.8c.4 0 .7 0 1 .1v2.8c-.3-.1-.6-.1-1-.1-1.7 0-3.1 1.4-3.1 3.1s1.4 3.1 3.1 3.1 3.1-1.4 3.1-3.1V3h3.9Z"
      fill="currentColor"
    />
  </svg>
);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-[#D4AF37]/15">
          ...
          {/* <div className="space-y-3">
            ...
            <div className="space-y-3 text-xs sm:text-lg text-[#A5BFC4]">
