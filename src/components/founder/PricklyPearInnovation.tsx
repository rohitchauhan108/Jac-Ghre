          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative aspect-[3/4] w-full max-w-sm bg-[#006073] border border-[#D4AF37]/60 p-6 shadow-2xl group overflow-hidden">
                ...
                <div className="absolute top-3 left-3 px-3 py-1 bg-[#006073]/90 border border-[#D4AF37]/60 text-[10px]  font-bold text-[#D4AF37] uppercase">
                  SIGNATURE FORMULA
                </div>
                ...
                <div className="absolute bottom-4 inset-x-4 flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2.5 bg-[#006073]/90 hover:bg-[#007288] border border-[#D4AF37]/70 text-[#F3E5AB]  text-xs font-bold tracking-wider uppercase transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 bg-[#D4AF37] hover:bg-[#E5C365] text-[#062B35]  text-xs font-bold tracking-wider uppercase transition-colors flex items-center justify-center gap-1.5 shadow-lg cursor-pointer"
                  >
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h3 className=" text-3xl sm:text-4xl lg:text-5xl font-bold text-[#FBF9F3] uppercase leading-tight">
              ...
              <div className="pt-4 border-t border-[#D4AF37]/30 flex flex-wrap items-center justify-between gap-4">
                <div>
                  <span className="text-xs  text-[#8EAAB0] uppercase tracking-wider block">Bespoke Flacon 100ml</span>
                  <span className=" text-2xl font-bold text-[#D4AF37]">${elixirProduct.price} USD</span>
                </div>

                <div className="flex items-center gap-3">
                  <button
                    onClick={() => navigateToPage('hair-care')}
                    className="px-5 py-3 border border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37]/10  text-xs font-bold tracking-[0.2em] uppercase transition-colors"
                  >
                    View Hair Ritual
                  </button>
                  <button
                    onClick={() => addToCart(elixirProduct)}
                    className="px-6 py-3 bg-[#D4AF37] hover:bg-[#E5C365] text-[#062B35]  text-xs font-bold tracking-[0.2em] uppercase shadow-xl transition-colors cursor-pointer"
                  >
                    Acquire Elixir
                  </button>
                </div>
