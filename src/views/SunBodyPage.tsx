    ...
    <div className="pt-8 pb-28 bg-[#0C8A9B] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          {/* Summer Glow Card */}
          <div className="bg-gradient-to-br from-[#0C8A9B] to-[#097B8A] border-2 border-[#D4AF37]/60 p-8 shadow-2xl relative overflow-hidden flex flex-col justify-between">
            <div className="absolute -top-12 -right-12 w-48 h-48 bg-[#D4AF37]/15 rounded-full blur-2xl pointer-events-none" />
            <div>
              <div className="flex items-center justify-between mb-4">
                <span className="px-3 py-1 bg-[#D4AF37] text-[#0E4C5A] font-cinzel text-xs font-bold uppercase tracking-wider">
                  Hero Sun Creation
                </span>
              ...
              <div className="my-6 aspect-video bg-[#097B8A] border border-[#D4AF37]/30 flex items-center justify-center p-4">
                <img
            ...
            <div className="pt-4 border-t border-[#D4AF37]/30 flex items-center justify-between">
              ...
              <button
                ...
                className="px-6 py-3 bg-[#D4AF37] text-[#0E4C5A] font-cinzel text-xs font-bold uppercase tracking-wider hover:brightness-110 flex items-center gap-2"
              >
          ...
          <div className="bg-gradient-to-br from-[#0C8A9B] to-[#097B8A] border-2 border-[#D4AF37]/60 p-8 shadow-2xl relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <span className="px-3 py-1 bg-[#097B8A] border border-[#D4AF37]/50 text-[#D4AF37] font-cinzel text-xs font-bold uppercase tracking-wider">
                  Post-Sun Cleanser
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {sunProducts.map((mist) => {
              ...
              return (
                <div
                  key={mist.id}
                  className="bg-[#097B8A] border border-[#D4AF37]/40 hover:border-[#D4AF37] transition-all p-6 flex flex-col justify-between shadow-xl group"
                >
                  <div>
                    ...
                    <div className="aspect-square flex items-center justify-center p-4 bg-[#097B8A] border border-[#D4AF37]/20 my-3">
                      <img
                        src={mist.image}
                        alt={mist.name}
