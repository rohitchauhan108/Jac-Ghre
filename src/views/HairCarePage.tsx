      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        <div className="p-8 sm:p-12 bg-gradient-to-br from-[#0C8A9B] via-[#097B8A] to-[#097B8A] border-2 border-[#D4AF37]/60 shadow-2xl mb-24 relative overflow-hidden">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className=" text-2xl sm:text-3xl font-bold text-[#F7F4EB] uppercase">
          ...
          <div className="border-t border-[#D4AF37]/30 pt-8">
            <span className="text-xs  font-semibold tracking-[0.25em] text-[#D4AF37] uppercase block text-center mb-6">
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <h4 className=" text-xl font-bold text-[#F7F4EB] line-clamp-1">
                        {p.name}
                      </h4>
                    ...
                    <div className="mt-4 pt-3 border-t border-[#D4AF37]/20 flex items-center justify-between">
                      <span className="text-xl  font-bold text-[#F7F4EB]">
                        {formattedPrice}
                      </span>
                      <button
                        onClick={() => addToCart(p)}
                        className="px-3.5 py-1.5 bg-[#D4AF37] text-[#0E4C5A]  text-[11px] font-bold uppercase tracking-wider hover:brightness-110 flex items-center gap-1"
                      >
        ...
        <div className="mb-20">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h3 className=" text-3xl font-bold uppercase text-[#F7F4EB]">
                ...
                >
                  <div>
                    ...
                    <h4
                      ...
                      className=" text-base sm:text-lg font-bold text-[#F7F4EB] hover:text-[#D4AF37] cursor-pointer transition-colors"
                    >
                      {p.name}
                    </h4>
                    ...
                    {/* <p className="text-xs sm:text-xl text-[#8EAAB0] font-poppins mt-2 leading-relaxed line-clamp-3">
                      {p.shortDescription}
                    </p> */}
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[#D4AF37]/20 flex items-center justify-between">
                    ...
                    <button
                      onClick={() => addToCart(p)}
                      className="px-4 py-2 bg-[#D4AF37] text-[#0E4C5A]  text-xs font-bold uppercase tracking-wider hover:brightness-110 flex items-center gap-1.5"
                    >
