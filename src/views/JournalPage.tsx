      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <div className="space-y-12 mb-24">
          {articles.map((article) => (
            <div
              key={article.id}
              className="bg-[#097B8A] border border-[#D4AF37]/35 hover:border-[#D4AF37] transition-all p-6 sm:p-8 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center"
            >
              <div className="lg:col-span-5 relative aspect-[16/10] overflow-hidden bg-[#097B8A] border border-[#D4AF37]/25">
                <img
                  src={article.image}
                  alt={article.title}
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="p-3 bg-[#097B8A] border-l-2 border-[#D4AF37] text-xs font-poppins text-[#F3E5AB]">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BOTANICAL_INGREDIENTS.map((ing) => (
              <div
                key={ing.name}
                className="bg-[#097B8A] border border-[#D4AF37]/30 p-6 flex flex-col justify-between shadow-xl"
              >
                <div>
