              ...
              <div className="relative border-2 border-[#D4AF37] p-3 bg-[#006073] shadow-[0_20px_50px_rgba(0,96,115,0.8)]">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-[#006073]/90 border border-[#D4AF37]/40 backdrop-blur-md">
                  ...
                  <p className="text-xs font-outfit text-[#FBF9F3] mt-0.5">
                    Bridging French Haute Coiffure and Mediterranean Coastal Luxury.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="mt-16 p-8 bg-[#006073] border border-[#D4AF37] text-center max-w-4xl mx-auto space-y-4 shadow-2xl">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              <button
                ...
                className="px-6 py-3 bg-[#D4AF37] text-[#062B35] font-cinzel text-xs font-bold tracking-widest uppercase hover:brightness-110 transition-all flex items-center gap-2 cursor-pointer"
              >
