          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="p-6 bg-[#031820] border-2 border-[#D4AF37]/50 shadow-xl">
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-[#D4AF37] via-[#E5C365] to-[#B89028] text-[#062B35] font-cinzel text-xs sm:text-sm font-bold tracking-[0.2em] uppercase hover:brightness-110 shadow-xl flex items-center justify-center gap-2"
              >
