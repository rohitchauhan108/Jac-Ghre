        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20 bg-[#006073] border border-[#D4AF37]/30 p-8">
            ...
            <button
              ...
              className="mt-6 px-6 py-2.5 bg-[#D4AF37] text-[#062B35] font-cinzel text-xs font-bold uppercase tracking-wider hover:brightness-110"
            >
              Reset All Filters
            </button>
          </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[#D4AF37]/20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2.5 bg-[#D4AF37] text-[#062B35] font-cinzel text-xs font-bold uppercase tracking-wider hover:brightness-110 shadow-lg flex items-center gap-1.5 transition-all"
                      >
